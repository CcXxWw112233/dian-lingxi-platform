...
export default class index extends Component {
  ...
  renderDiffTypeContent = (type) => {
    ...
    switch (type) {
      case '1': // 资料收集中的填写人
        container = <FillInPersonContent onVisibleChange={this.onVisibleChange} {...this.props}/>
        break;
      case '2': // 审批类型中的审批人
        container = <ExamineAndApproveContent onVisibleChange={this.onVisibleChange} {...this.props} />
        break
      case '3': // 抄送中的抄送人 | 抄报人
        container = <DuplicateAndReportPerson onVisibleChange={this.onVisibleChange} {...this.props}/>
        break
      default: // 其他的显示完成期限
        container = <CompleteDeadlineContent onVisibleChange={this.onVisibleChange} {...this.props}/>
        break;
    }
    return container
  }
