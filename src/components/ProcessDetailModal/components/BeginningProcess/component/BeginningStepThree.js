...
export default class BeginningStepThree extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      is_show_spread_arrow: props.itemValue.status == '1' || (props.itemKey == approve_position -1) || (props.itemValue.runtime_type == '1') || (props.itemKey == rating_position -1) || (props.itemKey == (overrule_position != '' ? Number(overrule_position) + 1 : '')) ? true : false, // 是否展开箭头 详情 true表示展开
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!isObjectValueEqual(this.props, nextProps)) {
      ...
      this.setState({
        is_show_spread_arrow: nextProps.itemValue.status == '1' || (nextProps.itemKey == approve_position -1) || (nextProps.itemValue.runtime_type == '1') || (nextProps.itemKey == rating_position -1) || (nextProps.itemKey == (overrule_position != '' ? Number(overrule_position) + 1 : '')) ? true : false,
...
function mapStateToProps({
  ...
  return { processEditDatas, processInfo, projectDetailInfoData, userBoardPermissions }
}