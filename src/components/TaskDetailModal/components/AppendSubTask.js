...
export default class AppendSubTask extends Component {
  ...
  render() {
    const { children, drawContent = {}, projectDetailInfoData: { data: dataInfo = [] }, dispatch, handleTaskDetailChange, handleChildTaskChange, whetherUpdateParentTaskTime, updateRelyOnRationList, boardFolderTreeData } = this.props
