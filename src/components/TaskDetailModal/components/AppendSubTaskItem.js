              ...
              <div>
                {local_start_time ? (
                  <div className={appendSubTaskStyles.due_time}>
                    <div>
                      <span>
                        {timestampToTimeNormal3(local_start_time, true)}
                      </span>
                      <span
              ...
              <div>
                {local_due_time ? (
                  <div className={appendSubTaskStyles.due_time}>
                    <div>
                      <span>
                        {timestampToTimeNormal3(local_due_time, true)}
                      </span>
                      <span
                    ...
                    <div>
                      ...
                      >
                        {local_executor && local_executor.length ? (
                          local_executor.map(({ name, avatar }, index) => (
                            <AvatarList.Item
                              key={index}
                              tips={name}
                              src={
                    ...
                    >
                      ...
                      <div className={appendSubTaskStyles.file_info}>
                        ...
                        {fileInfo.create_time &&
                          timestampFormat(fileInfo.create_time, 'MM-dd hh:mm')}
                      </div>
                      <div
