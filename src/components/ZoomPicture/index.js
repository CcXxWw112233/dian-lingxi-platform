...
class ZoomPicture extends Component {
  ...
  getCommentBlockListItemPosition = (x, y, width, height) => {
    const { imgRealWidth, imgWidth, offsetLeft: imgOffsetLeft, offsetTop: imgOffsetTop } = this.state;
    const rate = imgWidth / imgRealWidth;
    return {
      ...
      <div className={styles.commentItemPopoverContentWrapper}>
        <div className={styles.commentItemPopoverContentCommentList}>
          {currentSelectedCommentItemDetail.map(i => {
            return (
              <div className={styles.commentItemPopoverContentCommentListItem}>
                <div
                  className={
  ...
  render() {
    ...
    return (
        ...
        >
          ...
          <div
          className={styles.wrapper}
          style={{width: bodyClientWidth - 100, height: bodyClientHeight - 50, textAlign: 'center'}}
          ref={this.containerRef}
        >
          <div className={styles.content_wrapper}>
            <div className={styles.img_wrapper} style={imgWrapperStyle}>
...
ZoomPicture.defaultProps = {
  ...
  currentSelectedCommentItemDetail: [
    ...
    {
      update_time: '1557026896',
      flag: '2',
      full_name: '13600419123',
      create_time: '1557026896',
      user_id: '1111189894887247872',
      board_id: '1120583872338333696',
      file_id: '1122396197282254848',
      coordinates: { x: 227.3, y: 196, width: 48, height: 48, isAready: false },
      mobile: '13600419123',
      id: '1124878450285481984',
      text: 'oooooooooooooo',
      type: '1'
    },
    {
      update_time: '1557026906',
      flag: '2',
      full_name: '13600419123',
      create_time: '1557026906',
      user_id: '1111189894887247872',
      board_id: '1120583872338333696',
      file_id: '1122396197282254848',
      coordinates: { x: 227.3, y: 196, width: 48, height: 48, isAready: false },
      mobile: '13600419123',
      id: '1124878488667557888',
      text: 'iiiiiiiiiiiiiiii',
      type: '1'
    },
    {
      update_time: '1557026911',
      flag: '2',
      full_name: '13600419123',
      create_time: '1557026911',
      user_id: '1111189894887247872',
      board_id: '1120583872338333696',
      file_id: '1122396197282254848',
      coordinates: { x: 227.3, y: 196, width: 48, height: 48, isAready: false },
      mobile: '13600419123',
      id: '1124878510775734272',
      text:
        'qqqqqqqqqqqqqqqqqqffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff',
      type: '1'
    }
  ]
};
