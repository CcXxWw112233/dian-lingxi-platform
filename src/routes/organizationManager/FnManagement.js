...
export default class FnManagement extends React.Component{
  ...
  componentWillReceiveProps(nextProps) {
    this.setState({
      basic_datas: nextProps.model.datas.fnmanagement_list && nextProps.model.datas.fnmanagement_list.base_function_list,
      experiment_datas: nextProps.model.datas.fnmanagement_list && nextProps.model.datas.fnmanagement_list.experiment_function_list
    })
  }
  render() {
