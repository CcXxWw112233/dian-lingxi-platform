          ...
          <div className={indexStyles.manImageDropdown_top}>
            ...
            {role_id === '3'? ('') : (
              <Dropdown overlay={manOperateMenu(props)}>
                <div className={indexStyles.manImageDropdown_top_operate}><Icon type="ellipsis" theme="outlined" /></div>
              </Dropdown>
            )}
    ...
    return (
      <div>
        ...
        <div className={indexStyles.itemStyle}>
          <div className={indexStyles.plusBtn} onClick={this.setShowAddMenberModalVisibile.bind(this)}>
            <Icon type="plus" style={{color: '#8c8c8c', fontSize: 20, fontWeight: 'bold', marginTop: 8}}/>
          </div>
          <div className={indexStyles.itemList}>
            {
              managementArr && managementArr.map((value, key) => {
                const { avatar } = value
                return (
                      ...
                      <Dropdown overlay={manImageDropdown(value)}>
                        {avatar?(<img src={avatar} />): (
                          <div style={{width: 36, height: 36, borderRadius: 36, backgroundColor: '#f2f2f2', textAlign: 'center'}}>
                            <Icon type={'user'} style={{fontSize: 20, color: '#8c8c8c', marginTop: 8}}/>
                          </div>
                        )
                        }
                      </Dropdown>
