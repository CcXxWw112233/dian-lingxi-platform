...
export default class TeamList extends React.Component {
  ...
  render() {
    ...
    const {
      datas: { teamShowList = [], total, currentPageNo }
    } = this.props.model
    return (
      <div className={indexStyles.teamListOut}>
        <div className={indexStyles.head}>
          <div className={indexStyles.head_left}>
            <Button
              style={{ fontSize: 14 }}
              size={'small'}
              onClick={this.gotoEditTeamShow.bind(this)}
            >
              发布管理
            </Button>
          </div>
          ...
          <div className={indexStyles.head_right}>
            ...
            <Icon
              onClick={this.setShowType.bind(this, '1')}
              type="appstore-o"
              style={{
                fontSize: 16,
                marginRight: 16,
                color: showType === '1' ? '#262626' : '#8c8c8c'
              }}
            />
            <Icon
              type="bars"
              onClick={this.setShowType.bind(this, '2')}
              style={{
                fontSize: 18,
                color: showType === '2' ? '#262626' : '#8c8c8c'
              }}
            />
          </div>
        </div>
        <div
          className={
            showType === '1'
              ? indexStyles.teamList_list_1
              : indexStyles.teamList_list_2
          }
        >
        ...
        <div
          style={{
            marginTop: 40,
            display: teamShowList.length ? 'none' : 'block',
            fontSize: 16,
            color: '#8c8c8c'
          }}
        >
        ...
        <div
          style={{
            marginTop: 40,
            display: teamShowList.length ? 'block' : 'none'
          }}
        >
          <Pagination
            total={Number(total)}
