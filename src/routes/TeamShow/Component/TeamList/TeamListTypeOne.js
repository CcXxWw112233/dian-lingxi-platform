...
export default class TeamListTypeOne extends React.Component{
  ...
  render(){
    ...
    return(
      <div className={indexStyles.teamList_list_1_item} onClick={this.gotoLook.bind(this, id)}>
        ...
        <div className={indexStyles.description} dangerouslySetInnerHTML={{__html: summary}}>
        </div>
      </div>
    )
  }
