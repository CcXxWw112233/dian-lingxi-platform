...
export default class FlowInstances extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (board_id != next_board_id) { //切换项目时做请求
            this.getFlowsList(this.state.list_type, nextProps.simplemodeCurrentProject)
        }
    }
    // 获取流程列表
        ...
        return (
            <>
                ...
                <div className={styles.flows_bott}>
                    <FlowTables list_type={list_type} list_source={list_source} workbenchBoxContent_height={this.props.workbenchBoxContent_height} />
                </div>
            </>
        )
    }
