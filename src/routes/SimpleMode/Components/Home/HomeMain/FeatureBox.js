...
import { WorkbenchPages } from '../../WorkbenchPage/constans'
    ...
    switch (code) {
      ...
      case 'meetingmanage':
        contain = (
          ...
          >
            <path
              d="M865.28 128H158.72C141.824 128 128 141.84 128 158.752v482.4c0 16.912 13.824 30.752 30.72 30.752h322.56L273.536 879.856 289.664 896 500.48 684.96v161.84h23.04V684.96L734.336 896l16.128-16.144L542.72 671.904h322.56c16.896 0 30.72-13.84 30.72-30.752V158.752A30.576 30.576 0 0 0 865.28 128z"
              fill="#FFFFFF"
              p-id="12085"
            ></path>
            <path
              d="M560.752 544.4a29.088 29.088 0 0 1 49.04-28.368 149.264 149.264 0 0 0 48.8-84.48 29.072 29.072 0 0 1 0-56.688 149.264 149.264 0 0 0-48.8-84.48 29.088 29.088 0 0 1-49.04-28.384 150.08 150.08 0 0 0-97.536 0.032 29.088 29.088 0 0 1-49.04 28.368 149.264 149.264 0 0 0-48.8 84.48 29.072 29.072 0 0 1 0 56.688 149.264 149.264 0 0 0 48.8 84.48 29.088 29.088 0 0 1 49.04 28.384 149.44 149.44 0 0 0 97.536-0.032zM448 403.2a63.968 63.968 0 0 1 127.936 0 64 64 0 0 1-63.952 64 64 64 0 0 1-63.984-64z"
              fill="#D8D8D8"
              p-id="12086"
            ></path>
          </svg>
      ...
      case WorkbenchPages.CalendarPlan.key:
        contain = (
          ...
          >
            <path
              d="M923.008 457.386667v429.354666c0 16.64-12.373333 30.293333-28.416 32.426667l-4.437333 0.298667H133.845333a32.810667 32.810667 0 0 1-32.554666-28.245334l-0.298667-4.48V457.429333h822.016z m-223.530667 265.813333H309.845333a32.725333 32.725333 0 0 0 0 65.408h389.632a32.725333 32.725333 0 0 0 0-65.408z m-66.730666-132.693333H318.208a32.725333 32.725333 0 0 0-4.437333 65.152l4.437333 0.298666h314.538667a32.725333 32.725333 0 0 0 0-65.408zM372.266667 101.717333c3.754667 0 6.954667 2.56 7.893333 6.016l0.298667 2.176v65.408h263.082666V109.866667c0-3.754667 2.56-6.912 6.016-7.893334l2.176-0.298666h57.557334c3.754667 0 6.954667 2.56 7.936 6.016l0.298666 2.176v65.408h172.629334c16.64 0 30.378667 12.288 32.554666 28.288l0.298667 4.437333v179.925333H100.992V208c0-16.597333 12.373333-30.250667 28.416-32.426667l4.437333-0.298666h172.629334V109.866667c0-3.754667 2.56-6.912 6.058666-7.893334l2.176-0.298666h57.557334z"
              p-id="25140"
              fill="#ffffff"
            ></path>
          </svg>
      ...
      <>
        {tipTitle ? (
          <Tooltip title={tipTitle} key={item.id}>
            <div
              key={item.id}
              className={`${indexStyles.myWorkbenchBox} ${!projectList.length &&
                indexStyles.myWorkbenchBox2}`}
            ...
            >
              ...
              <div>{this.renderIconSVG(item.code)}</div>
...
export default connect(
  ({
    ...
    simplemode: { myWorkbenchBoxList, simplemodeCurrentProject },
    technological: {
      datas: {
        currentUserOrganizes,
        currentSelectedProjectOrgIdByBoardId,
