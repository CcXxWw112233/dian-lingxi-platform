    ...
    return (
      ...
      <div className={indexStyles.mainContentWapper}>
        ...
        <div className={indexStyles.myWorkbenchBoxWapper}>
          ...
          {
            projectList.length ? (
              <div className={indexStyles.myWorkbenchBox} onClick={this.addMyWorkBoxs} style={{ paddingTop: 18 }}>
