...
import DetailConfirmInfoThree from '../../../components/ProjectDetail/Process/ProcessDetail/DetailConfirmInfoThree'
      ...
      <div>
        ...
        <div style={{ height: '210px', padding: '32px 34px 70px 0', display: 'flex', flexDirection: 'column', justifyContent: 'space-around' }}>
          ...
          <div style={{
            ...
            fontWeight: '400',
            color: 'rgba(89,89,89,1)'
          }}>{this.props.model.datas.processInfo.description ? delHtmlTag(this.props.model.datas.processInfo.description) : '暂无描述'}</div>
        </div>
        {/* 这里将会有一个蒙层 */}
