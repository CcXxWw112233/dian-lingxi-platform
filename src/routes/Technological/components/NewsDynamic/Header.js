...
export default class Header extends React.Component {
  ...
  render() {
    ...
    const menu = (
      <Menu>
        <Menu.Item key={'1'}>全部项目</Menu.Item>
    ...
    return (
      <div className={indexStyle.out}>
        <div className={indexStyle.left}>
          <div
            className={defaultChooseTab === '1' ? indexStyle.tableChoose : ''}
            onClick={this.tabItemClick.bind(this, '1')}
          >
            全部消息
          </div>
          <div
            className={defaultChooseTab === '2' ? indexStyle.tableChoose : ''}
          >
            已读消息
          </div>
          <div
            className={defaultChooseTab === '3' ? indexStyle.tableChoose : ''}
          >
            稍后处理
          </div>
          <div
        ...
        <div className={indexStyle.right}>
          ...
          <Icon
            type="appstore-o"
            style={{ fontSize: 14, marginTop: 18, marginLeft: 16 }}
          />
        </div>
      </div>
    )
