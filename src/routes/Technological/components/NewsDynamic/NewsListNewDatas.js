...
import {
  ORGANIZATION, TASKS, FLOWS, DASHBOARD, PROJECTS, FILES, MEMBERS, CATCH_UP, ORG_TEAM_BOARD_QUERY, NOT_HAS_PERMISION_COMFIRN, MESSAGE_DURATION_TIME, PROJECT_TEAM_CARD_INTERVIEW,
...
export default class NewsListNewDatas extends React.Component {
  ...
  render() {
    ...
    const filterTitleContain = (activity_type, messageValue) => {
      ...
      let jumpToMeeting = (
        <span
          ...
          onClick={() => { this.goToMeeting({ join_url: messageValue.content.meeting && messageValue.content.meeting.join_url }) }}
        >{messageValue.content && messageValue.content.meeting && messageValue.content.meeting.meeting_name}</span>
      )
      ...
      switch (activity_type) {
        ...
        case 'board.update.name': // 更新项目信息
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 修改了原项目名 「{messageValue.content && messageValue.content.rela_data}」为「{jumpToBoard}」名称</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.update.description': // 修改项目描述
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 修改了「{jumpToBoard}」的{currentNounPlanFilterName(PROJECTS)}描述</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        ...
        case 'board.update.app.remove': // 移除项目功能
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 移除了「{messageValue.content.rela_data && messageValue.content.rela_data}」的功能</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.update.app.add': // 添加了项目的功能
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 添加了「{messageValue.content.rela_data && messageValue.content.rela_data}」的功能</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.flow.node.deadline.set': // 设置流程节点时间
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 设置了{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」中步骤「{messageValue.content.flow_node_instance && messageValue.content.flow_node_instance.name}」的截止时间</div>
        ...
        case 'board.flow.task.attach.upload': // 在流程中上传文件
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在流程「{jumpToProcess}」上传了文件
        ...
        case 'board.update.user.add': // 项目中添加成员
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 邀请「{messageValue.content.rela_users && Array.isArray(messageValue.content.rela_users) && messageValue.content.rela_users}」加入了「{jumpToBoard}」{currentNounPlanFilterName(PROJECTS)}</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.content.link.add': // 新增的关联内容
          ...
          if (messageValue.content && messageValue.content.rela_data && messageValue.content.rela_data.type) {
            if (messageValue.content.rela_data.type == '3') { // 表示任务
              link_message = (
                <span>
                  在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中新增了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
              </span>
              )
            } else if (messageValue.content.rela_data.type == '2') { // 表示流程
              link_message = (
                <span>
                  在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」中新增了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
              </span>
              )
            } else if (messageValue.content.rela_data.type == '21') { // 表示流程节点
              link_message = (
                <span>
                  在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」的节点「{messageValue.content.flow_node && messageValue.content.flow_node.name}」中新增了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
              </span>
              )
            } else if (messageValue.content.rela_data.type == '4') { // 表示文件
              link_message = (
                <span>
                  在{currentNounPlanFilterName(FILES)}「{jumpToFile}」中新增了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
              </span>
              )
            }
          }
        ...
        case 'board.content.link.remove': // 移除关联内容
          ...
          if (messageValue.content && messageValue.content.rela_data && messageValue.content.rela_data.type) {
            if (messageValue.content.rela_data.type == '3') { // 表示任务
              link_message = (
                <span>
                  在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中移除了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
                </span>
              )
            } else if (messageValue.content.rela_data.type == '2') { // 表示流程
              link_message = (
                <span>
                  在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」中移除了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
                </span>
              )
            } else if (messageValue.content.rela_data.type == '21') { // 表示流程节点
              link_message = (
                <span>
                  在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」的节点「{messageValue.content.flow_node && messageValue.content.flow_node.name}」中移除了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
                </span>
              )
            } else if (messageValue.content.rela_data.type == '4') { // 表示文件
              link_message = (
                <span>
                  在{currentNounPlanFilterName(FILES)}「{jumpToFile}」中移除了关联内容「{messageValue.content.rela_data && messageValue.content.rela_data.name}」
                </span>
              )
            }
          }
        ...
        case 'board.update.user.role': // 设置用户在项目中的角色
          contain = `在${currentNounPlanFilterName(PROJECTS)}中设置职员角色`
          messageContain = (
            <div className={NewsListStyle.news_3}>
        ...
        case 'board.card.create':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 创建了{messageValue.content.card_type && messageValue.content.card_type == '0' ? currentNounPlanFilterName(TASKS) : '日程'}「{jumpToTask}」 </div>
          ...
          contain = `创建${messageValue.content.card_type && messageValue.content.card_type == '0' ? currentNounPlanFilterName(TASKS) : '日程'}`
          break
        ...
        case 'board.card.update.finish.child': // 子卡片的完成\
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」 中完成了子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
            <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
            <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.cancel.finish.child': // 取消完成子卡片
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」 中取消完成了子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
          <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
          <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.finish':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 完成了{currentNounPlanFilterName(TASKS)}「{jumpToTask}」 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToBoard}</div>
              <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
              <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.cancel.finish':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 取消完成{currentNounPlanFilterName(TASKS)}「{jumpToTask}」 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToBoard}</div>
              <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
              <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.delete.child': // 删除子卡片
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」中 删除了子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
            <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
            <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.name': // 更新卡片信息
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 修改了原{currentNounPlanFilterName(TASKS)}名「{messageValue.content.rela_data && messageValue.content.rela_data.name}」为「{jumpToTask}」 名称</div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
              <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
              <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.name.child': // 修改子卡片名称
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 修改了归属于{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」中的原子{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_data && messageValue.content.rela_data.name}」名称为{currentNounPlanFilterName(TASKS)}「{jumpToTask}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.card.update.startTime':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中修改了开始时间 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
              <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
              <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.dutTime':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中修改了结束时间 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
              <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
              <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.dutTime.child': // 修改子卡片的结束时间
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 修改了归属于{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」的子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」的结束时间 </div>
              {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
            <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
            <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.description': // 修改卡片的描述
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中更新了{currentNounPlanFilterName(TASKS)}「{jumpToTask}」的描述 </div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.card.update.executor.remove.child': // 移除子执行人
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在归属于{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」中的子{currentNounPlanFilterName(TASKS)}「{jumpToTask}」移除了负责人为 「{messageValue.content.rela_data && messageValue.content.rela_data.name}」 </div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.card.update.label.add':
          if (messageValue.content.rela_data !== undefined) {
            messageContain = (
              <div className={NewsListStyle.news_3}>
                <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中添加了标签「{messageValue.content.rela_data && messageValue.content.rela_data.name}」</div>
                {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
              <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
              <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
                <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.label.remove': // 标签的移除
          if (messageValue.content.rela_data !== undefined) {
            messageContain = (
              <div className={NewsListStyle.news_3}>
                <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 删除了标签「{messageValue.content.rela_data && messageValue.content.rela_data.name}」「{jumpToTask}」</div>
                {/* <div className={NewsListStyle.news_3_card}>{jumpToTask}</div>
                <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：# {jumpToBoard}</div>
                <div className={NewsListStyle.news_3_group}>分组：{messageValue.list_name?messageValue.list_name:'无'}</div> */}
                <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
        ...
        case 'board.card.update.file.add': // 上传文件附件
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)} 「{jumpToTask}」中上传了文件附件 「{messageValue.content.rela_data && messageValue.content.rela_data.name}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.update.file.remove': // 移除附件
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)} 「{jumpToTask}」中移除了文件附件 「{messageValue.content.rela_data && messageValue.content.rela_data.name}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.add.to.milestone': // 添加里程碑关联内容
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中添加了关联里程碑「{messageValue.content.milestone && messageValue.content.milestone.name}」内容</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.remove.to.milestone': // 把任务从里程碑中删除
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」中移除了关联里程碑「{messageValue.content.milestone && messageValue.content.milestone.name}」的内容</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.list.group.add': // 添加分组
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中添加了分组「{messageValue.content.lists && messageValue.content.lists.name}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.list.group.update.name': // 更新分组
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)} 「{jumpToBoard}」中更新了原分组 「{messageValue.content.rela_data && messageValue.content.rela_data}」名称为「{messageValue.content.lists && messageValue.content.lists.name}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.list.group.remove': // 删除卡片分组
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中移除了分组「{messageValue.content.lists && messageValue.content.lists.name}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.flow.task.pass': // 流程通过
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」 中完成了任务「{messageValue.content.flow_node_instance && messageValue.content.flow_node_instance.name}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.flow.instance.discontinue':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 终止了{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」</div>
              {/* 「{messageValue.content.flow_node_instance.name}」 */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.flow.instance.delete': // 删除流程
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 删除了{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」</div>
              {/* 「{messageValue.content.flow_node_instance.name}」 */}
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.file.upload':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(PROJECTS)} 「{jumpToBoard}」中上传了{currentNounPlanFilterName(FILES)}「{jumpToFile}」</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        ...
        case 'board.file.comment.add': // 添加一条文件评论动态
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}> {messageValue.creator && messageValue.creator.name}在{currentNounPlanFilterName(FILES)}「{jumpToFile}」中发表了一条评论</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.file.comment.remove': // 移除文件评论
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}> {messageValue.creator && messageValue.creator.name}在{currentNounPlanFilterName(FILES)}「{jumpToFile}」中删除了一条评论</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        ...
        case 'board.flow.comment.add': // 添加流程评论
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}> {messageValue.creator && messageValue.creator.name}在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」中发表了一条评论</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.flow.comment.remove': // 移除流程评论
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}> {messageValue.creator && messageValue.creator.name}在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」中删除了一条评论</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
        case 'board.card.comment.at.notice': // 任务评论@通知
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}> {messageValue.creator && messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}「{jumpToTask}」的评论中@了您</div>
              <div className={NewsListStyle.news_3_time}>{timestampToHM(messageValue.created)}</div>
            </div>
          )
          break
            ...
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.creator && messageValue.creator.name}
                {
                  ...
                  <span>在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中</span>
                }
          ...
          <div className={NewsListStyle.top}>
            <div className={NewsListStyle.left}>
              <div className={NewsListStyle.l_l}>
                <div style={{ width: 40, height: 40, borderRadius: 40, position: 'relative' }}>
                  <span className={`${NewsListStyle.common_icon}`}><div className={`${globalStyles.authTheme}`}>&#xe61a;</div></span>
                </div>
              </div>
                  ...
                  <div className={NewsListStyle.news_4_top} key={key}>
                    ...
                    <div className={NewsListStyle.news_4_right}>
                      ...
                      <div className={NewsListStyle.r_b}>
                        {common_data.type == '14' && (card_comment['text'] != '' ? card_comment['text'] : common_text)}
    ...
    const commentNews = (value, parentKey, childrenKey, type) => {
      ...
      const { board = {}, card = {}, lists = {}, card_comment = {}, flow_instance = {} } = content
      const card_id = card['id']
            ...
            value.map((val, key) => {
              ...
              switch (action) {
                case 'board.card.update.comment.add': // 卡片添加评论
                  messageContain = (
                    <div>{CommonCommentNews(action, params, card_id, card_comment['id'])}</div>
                  )
                  break
                // case 'board.card.update.comment.remove': // 卡片删除评论
                //   messageContain = (
