        ...
        <div id={'detailInfoOut'} style={{ paddingLeft: '24px' }} className={`${DrawDetailInfoStyle.detailInfoOut} ${globalsetStyles.global_vertical_scrollbar}`} onScrollCapture={(e) => { this.onScroll(e, board_id) }} >
          ...
          {!editDetaiDescription ? (
            <div
              ...
              //   __html: value
              // }}
              className={`${DrawDetailInfoStyle.Bottom} ${defaultDescriptionVal != description && description != '' && DrawDetailInfoStyle.editColor}`} onClick={this.setEditDetaiDescriptionShow.bind(this)}>
