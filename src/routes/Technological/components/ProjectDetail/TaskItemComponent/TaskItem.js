...
export default class TaskItem extends React.Component {
  ...
  chirldrenTaskChargeChange = ({ selectedKeys = [] }) => {
    ...
    const currentSelect = data.filter(
      item => selectedKeys.indexOf(item.user_id) > -1
    )
    // debugger
    this.setState({
  ...
  render() {
    const {
      ...
      addNewTaskName,
      elseElementHeight,
      taskGroupOperatorDropdownMenuVisible,
    ...
    return (
      <div
        className={CreateTaskStyle.taskItem}
      ...
      >
        {!isInEditName ? (
          <div className={CreateTaskStyle.title}>
            ...
            <div
              ...
              id="title_l"
              className={CreateTaskStyle.title_l}
            >
              <div className={CreateTaskStyle.title_l_name}>{list_name}</div>
              <div>
                <Icon type="right" className={[CreateTaskStyle.nextIcon]} />
              </div>
              {editable === '1' &&
              checkIsHasPermissionInBoard(PROJECT_TEAM_CARD_GROUP) ? (
                <Dropdown
                  ...
                  overlay={operateMenu()}
                  trigger={['click']}
                  visible={taskGroupOperatorDropdownMenuVisible}
                  onVisibleChange={
                    this.handleTaskGroupOperatorDropdownMenuVisibleChange
                  }
                >
            ...
            <div className={CreateTaskStyle.title_r}></div>
          </div>
        ) : (
          <div
        ...
        <div
          className={CreateTaskStyle.cardListOut}
          style={{ maxHeight: cardListOut }}
        >
            ...
            <div key={'adds'} className={CreateTaskStyle.addNewTask}>
              <div className={CreateTaskStyle.addNewTask_top}>
                <TextArea
                  ...
                  onChange={this.addNewTaskNameTextAreaChange.bind(this)}
                />
              </div>
              <div className={CreateTaskStyle.addNewTask_bott}>
                <div className={CreateTaskStyle.addNewTask_bott_left}>
                  ...
                  <div className={CreateTaskStyle.addNewTask_bott_left_select}>
                    <div
                      className={
                        addTaskType === '0'
                          ? CreateTaskStyle.select_left2
                          : CreateTaskStyle.select_left
                      }
                      onClick={this.setAddTaskType.bind(this, '0')}
                    >
                    ...
                    <div
                      className={
                        addTaskType === '1'
                          ? CreateTaskStyle.select_right2
                          : CreateTaskStyle.select_right
                      }
                      onClick={this.setAddTaskType.bind(this, '1')}
                    >
                      <i className={globalStyle.authTheme}>&#xe709;</i>
                    </div>
                  </div>
                  ...
                  <div
                    className={
                      CreateTaskStyle.addNewTask_bott_left_selectMeeting
                    }
                  >
                    <Icon
                      type={'calendar'}
                      style={{
                        color: start_time && due_time ? '#262626' : '#8c8c8c'
                      }}
                    />
                    <RangePicker
                      ...
                      className={
                        CreateTaskStyle.addNewTask_bott_left_rangePicker
                      }
                      style={{ width: 20 }}
                    />
                  </div>
                ...
                <div className={CreateTaskStyle.addNewTask_bott_right}>
                  <Button
                    ...
                    onClick={this.cancelAddNewTask.bind(this)}
                  >
                    取消
                  </Button>
                  <Button
                    ...
                    onClick={this.checkAddNewTask.bind(this)}
                  >
                    确认
                  </Button>
                </div>
...
function mapStateToProps({
  projectDetailTask: {
    datas: { getTaskGroupListArrangeType }
  },
  projectDetail: {
