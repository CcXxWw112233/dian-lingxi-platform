 ...
 */
  ...
  updateProcessPercent = () => {
    const { dispatch } = this.props
    const { board_id, filePreviewCurrentFileId, currentPreviewFileBaseInfo = {} } = this.props
          ...
          is_petty_loading ? (
            <CirclePreviewLoadingComponent
              ...
              <>
                ...
                {
                  this.props.fileType != '.pdf' && (supportFileTypeArray.indexOf(this.props.fileType) != -1 || supportPictureFileTypeArray.indexOf(this.props.fileType) != -1) && (
