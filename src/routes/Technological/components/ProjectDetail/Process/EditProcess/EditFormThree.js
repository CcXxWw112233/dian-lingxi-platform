...
export default class EditFormThree extends React.Component {
  ...
  render() {
    const { processEditDatasRecords = [], processEditDatas = [], processCurrentEditStep = 0, projectDetailInfoData = {} } = this.props
    ...
    const filterForm = (value, key) => {
      ...
      switch (field_type) {
        case '1':
          container = (
            <EditFormThree_One itemKey={key} itemValue={value} updateEdit={this.updateEdit.bind(this)} />
          )
          break
        case '3':
          container = (
            <EditFormThree_Two itemKey={key} itemValue={value} updateEdit={this.updateEdit.bind(this)} />
          )
          break
        case '2':
          container = (
            <EditFormThree_Three itemKey={key} itemValue={value} updateEdit={this.updateEdit.bind(this)} />
          )
          break
        default:
          break
