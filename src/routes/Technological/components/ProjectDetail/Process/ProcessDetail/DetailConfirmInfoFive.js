        ...
        if (Number(sort) < Number(curr_node_sort)) {
          ...
          container = (
            ...
            >
              ...
              <Button
                onClick={this.setOpinionModalVisible.bind(this, '2')}
                style={{ marginRight: 14 }}
              >
                拒绝
              </Button>
              <Button onClick={this.setOpinionModalVisible.bind(this, '1')}>
                通过
              </Button>
            </div>
          )
    ...
    const imgOrAvatar2 = (value, key) => {
      ...
      return avatar ? (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          {approve_type === '1' ? (
            Number(key) === assigneesArray.length - 1 ? (
              <div></div>
            ) : (
              <div>
                <Icon
                  type="swap-right"
                  theme="outlined"
                  style={{ fontSize: 12, marginRight: 10, color: '#8c8c8c' }}
                />
              </div>
            )
          ) : (
