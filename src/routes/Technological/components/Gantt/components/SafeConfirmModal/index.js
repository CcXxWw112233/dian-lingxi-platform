        ...
        return (
            ...
            >
                <div style={{ margin: '12px 8px' }}>
                    ...
                    <span style={{ fontSize: '16px', fontWeight: '600', color: ':rgba(0,0,0,0.85)' }}>确认要引用【{selectedTpl.name}】{currentNounPlanFilterName(PROJECTS)}模版吗？</span>
                </div>
                <div style={{ margin: '12px 0px 12px 46px', color: 'rgba(0,0,0,0.65)' }}>
                    引用{currentNounPlanFilterName(PROJECTS)}模版会覆盖删除项目现有的数据。
