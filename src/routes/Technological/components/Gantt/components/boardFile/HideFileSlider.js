...
export default class ShowFileSlider extends Component {
    ...
    render() {
        ...
        return (
            <div className={`${styles.hide_file_button}`}
                onClick={this.setShowBoardFileHide}>
                <span style={{ display: 'inline-block', marginRight: 4 }} className={`${globalStyles.authTheme}  ${is_show_board_file_area == '1' && styles.spin_show}
