...
export default class AppendSubTask extends Component {
  ...
  render() {
    const { children, drawContent = {}, dispatch, handleTaskDetailChange, handleChildTaskChange, whetherUpdateParentTaskTime, updateRelyOnRationList, boardFolderTreeData, projectDetailInfoData, handleRelyUploading, projectDetailInfoData: { data: dataInfo = [] } } = this.props
