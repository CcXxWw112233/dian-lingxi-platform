...
export default class AppendSubTaskItem extends Component {
  ...
  setChildTaskIndrawContent = ({ name, value, operate_properties_code }, card_id, rely_card_datas, res) => {
    ...
    if ((name && value) || (name && value == null)) {
      ...
      typeof res == 'object' && rebackCreateNotify.call(this, { res, id: card_id, board_id, group_view_type, dispatch, parent_id: drawContent.card_id }) //创建撤回弹窗
    }
  }
  ...
  deleteConfirm({ card_id, childDataIndex }) {
    ...
    Promise.resolve(
      ...
      const { group_view_type, board_id } = this.props
      rebackCreateNotify.call(this, { res, id: card_id, board_id, group_view_type, dispatch, parent_id: drawContent.card_id }) //创建撤回弹窗
    })
  }
