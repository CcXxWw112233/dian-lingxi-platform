...
export default class GetRowGantt extends Component {
  ...
  componentDidMount() {
    this.target_c = this.refs.gantt_operate_area_panel//event.target || event.srcElement;
    this.target_0 = document.getElementById('gantt_card_out')
    this.target_1 = document.getElementById('gantt_card_out_middle')
  ...
  dashedMousedown(e) {
    ...
    this.target_c.onmousemove = this.dashedDragMousemove.bind(this);
    this.target_c.onmouseup = this.dashedDragMouseup.bind(this);
  }
  dashedDragMousemove(e) {
    ...
    // 取得鼠标位置
    const x = e.pageX - this.target_0.offsetLeft + this.target_1.scrollLeft - coperatedLeftDiv - coperatedX
    const y = e.pageY - this.target_c.offsetTop + this.target_1.scrollTop - dateAreaHeight
    //设置宽度
  ...
  stopDragging() {
    ...
    this.target_c.onmousemove = null;
    this.target_c.onmuseup = null;
    const that = this
    setTimeout(function () {
  ...
  dashedMouseMove(e) {
    ...
    // const target_1 = document.getElementById('gantt_card_out_middle')
    // 取得鼠标位置
    let px = e.pageX - this.target_0.offsetLeft + this.target_1.scrollLeft - coperatedLeftDiv - coperatedX
    let py = e.pageY - this.target_0.offsetTop + this.target_1.scrollTop - dateAreaHeight
