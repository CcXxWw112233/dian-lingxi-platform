  ...
  render() {
    ...
    const filterTitleContain = (activity_type, messageValue) => {
      ...
      let jumpToBoard = (
        ...
        >{(messageValue.content && messageValue.content.board) && messageValue.content.board.name}</span>
      )
      let jumpToTask = (
        <span
          style={{ color: '#1890FF', cursor: 'pointer', maxWidth: 100, overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis', display: 'inline-block', verticalAlign: 'top' }}
      ...
      switch (activity_type) {
        ...
        case 'board.create':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.creator.name} 创建{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」
              </div>
        ...
        case 'board.update.name':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.creator.name} 修改了原项目名 「{messageValue.content && messageValue.content.rela_data}」为「{jumpToBoard}」名称
              </div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
        ...
        case 'board.delete':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>
                {messageValue.creator.name} 删除了「{jumpToBoard}」{currentNounPlanFilterName(PROJECTS)}
              </div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
        ...
        case 'board.card.create': // 创建任务
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 创建了{messageValue.content.card_type && messageValue.content.card_type == '0' ? currentNounPlanFilterName(TASKS) : '日程'}</div>
        ...
        case 'board.card.create.child': // 创建子卡片
          messageContain = (
            <div className={NewsListStyle.news_3}>
              ...
              <div className={NewsListStyle.news_3_group}>{messageValue.lists && messageValue.lists.name}</div>
              <div className={NewsListStyle.news_3_time}>{timestampToTimeNormal2(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.card.update.dutTime.child': // 修改子卡片的结束时间
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}修改了归属于{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」的子{currentNounPlanFilterName(TASKS)} </div>
              <div className={NewsListStyle.news_3_card}>「{jumpToTask}」的结束时间</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.card.update.description': // 修改卡片的描述
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中更新了{currentNounPlanFilterName(TASKS)}</div>
              <div className={NewsListStyle.news_3_card}>「{jumpToTask}」的描述</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.card.update.cancel.finish.child': // 取消子任务的完成
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」中 取消完成了子{currentNounPlanFilterName(TASKS)}</div>
              <div className={NewsListStyle.news_3_card}>「{jumpToTask}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
        ...
        case 'board.card.delete.child': // 删除子卡片
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)}「{messageValue.content.rela_card && messageValue.content.rela_card.name}」中删除了子</div>
              <div className={NewsListStyle.news_3_card}>「{jumpToTask}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
        ...
        case 'board.card.update.label.add': // 添加标签
          if (messageValue.content.rela_data !== undefined) {
            messageContain = (
              <div className={NewsListStyle.news_3}>
                <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(TASKS)} </div>
                <div className={NewsListStyle.news_3_card}>「{jumpToTask}」 中 添加了标签「{messageValue.content.rela_data && messageValue.content.rela_data.name}」 </div>
                <div className={NewsListStyle.news_3_project}>
                  <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                  {
                    is_show_org_name && (
        ...
        case 'board.card.update.label.remove': // 移除标签
          if (messageValue.content.rela_data !== undefined) {
            messageContain = (
              <div className={NewsListStyle.news_3}>
                <div className={NewsListStyle.news_3_text}>{messageValue.creator.name}在{currentNounPlanFilterName(TASKS)}</div>
                <div className={NewsListStyle.news_3_card}>「{jumpToTask}」中 删除了标签「{messageValue.content.rela_data && messageValue.content.rela_data.name}」</div>
                <div className={NewsListStyle.news_3_project}>
                  <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                  {
                    is_show_org_name && (
        ...
        case 'board.card.list.group.add': // 更新分组
          messageContain = (
            <div className={NewsListStyle.news_3}>
              ...
              <div className={NewsListStyle.news_3_text}>添加了分组{messageValue.content.lists && messageValue.content.lists.name}</div>
              <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
              {
                is_show_org_name && (
                  <div className={NewsListStyle.news_3_orgName}>
              ...
              {/* <div className={NewsListStyle.news_3_project}>{currentNounPlanFilterName(PROJECTS)}：{jumpToBoard}</div> */}
              <div className={NewsListStyle.news_3_project}>{jumpToBoard} > </div>
              <div className={NewsListStyle.news_3_group}>{messageValue.content.lists ? messageValue.content.lists.name : '无'}</div>
              <div className={NewsListStyle.news_3_time}>{timestampToTimeNormal2(messageValue.created)}</div>
            </div>
          )
        ...
        case 'board.card.list.group.update.name': //更新了分组名称
          messageContain = (
            <div className={NewsListStyle.news_3}>
              ...
              <div className={NewsListStyle.news_3_text}>中更新了原「{messageValue.content.rela_data && messageValue.content.rela_data}」分组名称为「{messageValue.content.lists && messageValue.content.lists.name}」</div>
              <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
              {
                is_show_org_name && (
                  <div className={NewsListStyle.news_3_orgName}>
        ...
        case 'board.flow.instance.initiate': // 启动流程
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中启动{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.flow.task.recall':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 撤回{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」节点「{messageValue.content.flow_node_instance && messageValue.content.flow_node_instance.name}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.flow.task.reject':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 驳回{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」节点「{messageValue.content.flow_node_instance && messageValue.content.flow_node_instance.name}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.flow.task.reassign':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」节点「{messageValue.content.flow_node_instance && messageValue.content.flow_node_instance.name}」中重新指定审批人 {messageValue.content.user.name}</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.flow.task.pass':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(FLOWS)}「{jumpToProcess}」 中完成了任务「{messageValue.content.flow_node_instance && messageValue.content.flow_node_instance.name}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.flow.instance.discontinue': // 中止流程
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 中止了流程「{jumpToProcess}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.flow.instance.delete': // 删除流程
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中 删除了流程「{jumpToProcess}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.folder.add':
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 创建了文件夹「{messageValue.content.board_folder && messageValue.content.board_folder.name}」</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.folder.remove.recycle':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在 「{jumpToBoard}」中 移动文件夹「{messageValue.content.board_folder && messageValue.content.board_folder.name}」到回收站</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
        ...
        case 'board.file.remove.recycle':
          ...
          messageContain = (
            <div className={NewsListStyle.news_3}>
              <div className={NewsListStyle.news_3_text}>{messageValue.creator.name} 在{currentNounPlanFilterName(PROJECTS)}「{jumpToBoard}」中移动{currentNounPlanFilterName(FILES)}「{jumpToFile}」到回收站</div>
              <div className={NewsListStyle.news_3_project}>
                <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                {
                  is_show_org_name && (
          ...
          {value.map((val, key) => {
            ...
            switch (action) {
                ...
                messageContain = (
                  <div className={NewsListStyle.news_3} key={key}>
                    ...
                    <div className={NewsListStyle.news_3_card}>{<span style={{ color: '#1890FF', cursor: 'pointer' }}
                      ...
                      })}>{val.content && val.content.card && val.content.card.name}</span>}」中发表了一条评论</div>
                    <div className={NewsListStyle.news_3_project}>
                      <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                      {
                        is_show_org_name && (
                ...
                messageContain = (
                  <div className={NewsListStyle.news_3} key={key}>
                    ...
                    <div className={NewsListStyle.news_3_card}>{<span style={{ color: '#1890FF', cursor: 'pointer' }}
                      ...
                      })}>{val.content && val.content.card && val.content.card.name}</span>}」中删除了一条评论</div>
                    <div className={NewsListStyle.news_3_project}>
                      <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                      {
                        is_show_org_name && (
                    ...
                    <div className={NewsListStyle.news_3_group}>{val.list_name ? val.list_name : '无'}</div>
                    <div className={NewsListStyle.news_3_time}>{timestampToTimeNormal2(val.created)}</div>
                  </div>
                )
                break
              case 'board.file.comment.add': // 添加文件评论
                messageContain = (
                  <div className={NewsListStyle.news_3} key={key}>
                    <div className={NewsListStyle.news_3_text}> {val.creator.name}在{currentNounPlanFilterName(FILES)}「</div>
                    <div className={NewsListStyle.news_3_card}>{<span style={{ color: '#1890FF', cursor: 'pointer' }}
                      onClick={() => this.props.dispatch({
                        type: 'newsDynamic/routingJump',
                        payload: {
                          route: `/technological/projectDetail?board_id=${val.content.board && val.content.board.id}&appsSelectKey=3&card_id=${val.content.board_file && val.content.board_file.id}`
                        }
                      })}>{val.content && val.content.board_file && val.content.board_file.name}</span>}」中发表了一条评论</div>
                    <div className={NewsListStyle.news_3_project}>
                      <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                      {
                        is_show_org_name && (
              ...
              case 'board.flow.comment.add': // 在流程中添加评论
                messageContain = (
                  <div className={NewsListStyle.news_3} key={key}>
                    <div className={NewsListStyle.news_3_text}> {val.creator.name}在{currentNounPlanFilterName(FLOWS)}「</div>
                    <div className={NewsListStyle.news_3_card}>{<span style={{ color: '#1890FF', cursor: 'pointer' }}
                      onClick={() => this.props.dispatch({
                        type: 'newsDynamic/routingJump',
                        payload: {
                          route: `/technological/projectDetail?board_id=${val.content.board && val.content.board.id}&appsSelectKey=3&card_id=${val.content.flow_instance && val.content.flow_instance.id}`
                        }
                      })}>{val.content && val.content.flow_instance && val.content.flow_instance.name}</span>}」中发表了一条评论</div>
                    <div className={NewsListStyle.news_3_project}>
                      <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                      {
                        is_show_org_name && (
                ...
                messageContain = (
                  <div className={NewsListStyle.news_3} key={key}>
                    ...
                    <div className={NewsListStyle.news_3_card}>{<span style={{ color: '#1890FF', cursor: 'pointer' }}
                      ...
                      })}>{val.content && val.content.flow_instance && val.content.flow_instance.name}</span>}」中删除了一条评论</div>
                    <div className={NewsListStyle.news_3_project}>
                      <span style={{ marginRight: 2, color: '#8C8C8C' }}>#</span>
                      {
                        is_show_org_name && (
