  ...
  render() {
    ...
    return (
      <div className={indexStyles.fileDetailOut} style={{height: clientHeight - offsetTopDeviation, top: 0}}>
        <Header status={this.props.status} visitControlUpdateCurrentModalData={this.props.visitControlUpdateCurrentModalData} {...this.props} close={this.props.close} setPreviewProccessModalVisibile = {this.props.setPreviewProccessModalVisibile}/>
