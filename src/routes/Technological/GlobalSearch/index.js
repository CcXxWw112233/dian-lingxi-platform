...
function mapStateToProps({ globalSearch: { datas: { defaultSearchType, globalSearchModalVisible, spinning, page_number } } }) {
  return {
    defaultSearchType, globalSearchModalVisible, spinning, page_number
  }
}
