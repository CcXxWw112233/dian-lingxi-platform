...
export default class AnotherItem extends React.Component {
  ...
  itemClick(data, e) {
    ...
    if(!checkIsHasPermission(ORG_TEAM_BOARD_QUERY) || !checkIsHasPermissionInBoard(PROJECT_FLOW_FLOW_ACCESS)){
    ...
    dispatch({
      ...
      payload: {
        route: `/technological/projectDetail?board_id=${board_id}&appsSelectKey=${APP_KEY.FLOW}&flow_id=${id}`
      }
    })
  }
  itemOneClick(e) {
