      ...
      <div className={indexStyles.contain_3_item} >
        <div className={indexStyles.contain_3_item_top}>
          <div className={indexStyles.contain_3_item_top_left}>
            <Avatar size={48} src={avatar}>u</Avatar>
          ...
          {type=='0'?(
            <div className={`${indexStyles.contain_3_item_top_right} ${isShowBottDetail ? indexStyles.upDown_up: indexStyles.upDown_down}`}>
              <Icon onClick={this.setIsShowBottDetail.bind(this)} type="down" theme="outlined" style={{color: '#595959'}}/>
            </div>
          ):('')}

        </div>
        {type=='0'?(
          <div id={ConfirmInfoOut_1_bott_Id} className={`${isShowBottDetail? indexStyles.contain_3_item_bott : indexStyles.contain_3_item_bott_bottNormal}`}>
