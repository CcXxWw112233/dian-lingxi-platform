...
class FormList extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      if (!err) {
        ...
        this.props.wechatSignupBindLogin ? this.props.wechatSignupBindLogin(values) : false
      }
    });
  }
  //验证账户,失去焦点
  ...
  render() {
    ...
    // debugger
    const hrefService = NODE_ENV == 'development'?'http://localhost/#/agreement/service':window.location.host.indexOf('lingxi') !== -1?window.location.href='https://lingxi.di-an.com/#/agreement/service':window.location.href='http://www.new-di.com/#/agreement/service',
    hrefPrivacy = NODE_ENV == 'development'?'http://localhost/#/agreement/privacy':window.location.host.indexOf('lingxi') !== -1?window.location.href='https://lingxi.di-an.com/#/agreement/privacy':window.location.href='http://www.new-di.com/#/agreement/privacy'
    return (
      <Form onSubmit={this.handleSubmit} style={{margin: '0 auto', width: 272}}>
        ...
        <FormItem style={{marginTop: 24}}>
          <Button type="primary" disabled={submitButtonDisabledLocal} htmlType="submit" style={{width: '100%', height: 40, fontSize: 16}}>注册并绑定微信</Button>
        </FormItem>
      </Form>
    );
  }
