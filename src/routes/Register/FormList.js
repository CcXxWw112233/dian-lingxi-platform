    ...
    return (
      <Form onSubmit={this.handleSubmit} style={{margin: '0 auto', width: 272}}>
        ...
        <div style={{marginTop: -4}}>
          ...
          />
           <span style={{color: '#000', fontSize: 14}}>同意 灵犀《<span href={hrefService} target='view_window' style={{color: '#1890FF', cursor: 'pointer'}}> 服务协议</span> <span href={hrefPrivacy} target='view_window' style={{color: '#1890FF', cursor: 'pointer'}}> 隐私协议</span>》</span>
        </div>
        {/* 确认 */}
