        ...
        <div style={{position: 'relative', marginTop: 0}}>
          ...
          {accountType === 'phone' && isShowCodeButton ? (
            <div style={{position: 'absolute',top:0 ,right: 0, color: '#bfbfbf',height: '40px',lineHeight: '40px',padding: '0 16px 0 16px',cursor: 'pointer',display: 'flex'}}>
              ...
              {/*<div>获取验证码</div>*/}
              <VerificationCodeTwo getVerifyCode={this.getVerifyCode.bind(this)} className={this.state.isMobile ? globalStyles.link_mouse : ''} style={{height: '36px',marginTop:2,backgroundColor:'#ffffff',fontSize: 16,width: 120,textAlign: 'center'}} text={'获取验证码'}/>
            </div>
          ) : ('')}
        </div>
