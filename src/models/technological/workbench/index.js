...
import {
  workbench_selectKnowPolicyArticles, workbench_selectKnowCityArticles, workbench_selectBoxList, workbench_selectBoxUsableList
} from "./selects";
...
export default modelExtend(technological, {
  ...
  effects: {
    ...
    * handleCurrentSelectedProjectChange({ payload }, { select, put, call }) {
      ...
      yield put({
        type: 'setProjectTabCurrentSelectedProject', payload: {
          projectId: board_id
        }
      })
      yield put({
